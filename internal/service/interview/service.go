...
type Storage interface {
	CreateQuestion(ctx context.Context, question dto_models.CreateQuestionRequest) (int64, error)
...
func (s *Service) CreateQuestion(ctx context.Context, req dto_models.CreateQuestionRequest) (int64, error) {
	return s.store.CreateQuestion(ctx, req)
}
